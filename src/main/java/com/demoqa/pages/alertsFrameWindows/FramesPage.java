...
public class FramesPage extends BasePage {
    ...
    public FramesPage returnListOfFrames() {
        ...
        System.out.println("The total number of iframes (by executing) is " + numberOfIframes);
        return this;
    }
    ...
    public FramesPage verifyByTitle(String title) {
    ...
    public FramesPage handleNestedIframes() {
        ...
        driver.switchTo().frame(frame1);
        //assert paren by text
        softly.assertThat(isContainsText("Parent frame",body));
        //assert numbers of iframe in parent iframe
