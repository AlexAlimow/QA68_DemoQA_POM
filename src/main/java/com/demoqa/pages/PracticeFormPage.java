...
public class PracticeFormPage extends BasePage {
    ...
    public PracticeFormPage enterPersonalData(String firstName, String lastName, String email, String phone) {
        scrollAndWaitOfElement(lastNameInput, 10, 0, 300);
    ...
    public PracticeFormPage typeOfDate(String date) {
        scrollAndWaitOfElement(dateOfBirthInput, 5, 0, 100);
    ...
    public PracticeFormPage addSubjects(String[] subjects) {
        scrollAndWaitOfElement(subjectsInput, 5, 0, 200);
    ...
    public PracticeFormPage inputState(String state) {
        scrollAndWaitOfElement(cityInput, 5, 0, 100);
